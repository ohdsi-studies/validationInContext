...
.createCohorts <- function(connection,
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "BleedModelVal")
  ...
  pathToCustom <- system.file("settings", 'CustomCovariates.csv', package = "BleedModelVal")
