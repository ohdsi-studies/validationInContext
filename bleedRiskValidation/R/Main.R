...
#
# This file is part of BleedModelVal
#
...
#'
#' @details
#' This function executes the BleedModelVal Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if(runAnalyses){
    ...
    for(i in 1:nrow(analysisSettings)){
      ...
      ParallelLogger::logInfo(paste0('Applying Model: ', analysisSettings$model[i]))
      ParallelLogger::logInfo(paste0('==========='))
      ParallelLogger::logInfo(paste0('Target: ', analysisSettings$targetName[i]))
      ParallelLogger::logInfo(paste0('Outcome: ', analysisSettings$outcomeName[i]))
      
      pathToStandard <- system.file("settings", gsub('_model.csv','_standard_features.csv',analysisSettings$model[i]), package = "BleedModelVal")
      if(file.exists(pathToStandard)){
        ...
        pathToInclude <- system.file("settings", gsub('_model.csv','_standard_features_include.csv',analysisSettings$model[i]), package = "BleedModelVal")
