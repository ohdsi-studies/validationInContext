...
OhdsiRTools::checkUsagePackage("bleedRiskPlp")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/bleedRiskPlp.pdf")
shell("R CMD Rd2pdf ./ --output=extras/bleedRiskPlp.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("bleedRiskPlp")
