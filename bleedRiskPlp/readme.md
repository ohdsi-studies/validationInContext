...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/bleedRiskPlp/inst/doc/UsingSkeletonPackage.pdf)
...
outputFolder <- "./bleedRiskPlpResults"
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/bleedRiskPlp")
```
